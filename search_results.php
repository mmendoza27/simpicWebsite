      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
         ...
         ?> 
            ...
            <li><a data-toggle="collapse" data-target="#search" href="#searchResults">Search</a></li>
    ...
    <?php
       ...
       if (mysqli_connect_errno()) {
         echo "Couldn't connect to database simpic: " . mysqli_connect_errno();
          ...
          $count = 0;
          while (isset($_SESSION["pid$count"])){
            $photoID = $_SESSION["pid$count"];
            $_SESSION["pid$count"] = NULL;
            $count = $count + 1;

                //Query user and user_images for image information 
                $imageqry = "SELECT * FROM user_images i, users u WHERE photo_id = $photoID";
